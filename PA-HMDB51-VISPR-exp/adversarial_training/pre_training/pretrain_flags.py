...
parser.add_argument('--pretrained_fdfT_ckpt_dir', type=str, default='pretrained_ckpts/pretrained_fdfT', help='saved ckpts for pretrained fd+fT')
parser.add_argument('--pretrained_fbfdfT_ckpt_dir', type=str, default='pretrained_ckpts/pretrained_fbfdfT', help='saved ckpts for pretrained fb')
# training hyperparameters
parser.add_argument('--pretraining_steps_fdfT', type=int, default=500, help='Number of steps for pretraining fT+fd')
parser.add_argument('--pretraining_steps_fbfdfT', type=int, default=1000, help='Number of steps for pretraining fT+fd')
