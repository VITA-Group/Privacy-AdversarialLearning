...
def fT(videos, _dropout, wd=0.0005):
    ...
    with tf.variable_scope('fT'):
        ...
        'out': _variable_with_weight_decay('wout', [4096, COMMON_FLAGS.NUM_CLASSES_UTILITY], wd)
        }
        biases = {
        ...
        'out': _variable_with_weight_decay('bout', [COMMON_FLAGS.NUM_CLASSES_UTILITY], 0.000),
        }
    # Convolution Layer
    conv1 = conv3d('conv1', videos, weights['wc1'], biases['bc1'])
